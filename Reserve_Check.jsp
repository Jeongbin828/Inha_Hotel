...
<head>
<meta charset="UTF-8">
<title>Inha Hotel Reserve Check Page</title>
...
<section id="reserve_check_section">
	<h2 style="margin-top:50px; margin-bottom: 30px;">예약 확인</h2>
	...
	<table class="check_table">
		<thead>
			<tr>
				...
				<th width=200>침대타입</th>
				<th width=200>가격</th>
				<th width=100>예약변경</th>
		...
		<tbody>
			<tr>
				...
				<td>더블(킹 사이즈), 트윈</td>
				<td><%= ch %>원</td>
				<td><a href="Reserve_Update_UI.jsp">변경</a></td>
				<td><a href="Reserve_Delete_Check.jsp">취소</a></td>
			</tr>
			<tr>
				<td>1</td>
				<td>2011-09-07</td>
