...
<head>
<meta charset="UTF-8">
<title>Inha Hotel Reserve Update Check Page</title>
...
<section id="reserve_check_section">
	<h2 style="margin: 50px 150px; font-size: 30px;">예약 변경 확인</h2>
	...
	<img src="image/bottom.svg" alt="bottom">
	<hr style="margin: 30px auto auto auto; width: 90%; height: 3px; background-color: black;">
	<table style="font-size: 20px;" class="check_table">
		<thead>
			<tr>
				<th width=100>예약번호</th>
	...
	<div style="margin-top: 50px;">
		<a href="Reserve_Update_UI.jsp">이전</a>
		<a href="Reserve_Update_Query.jsp">변경하기</a>
	</div>
</section>
