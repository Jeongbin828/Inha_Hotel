...
<head>
<meta charset="UTF-8">
<title>Inha Hotel Reserve Delete Check Page</title>
...
<section id="reserve_check_section">
	<h2 style="margin: 50px 150px; font-size: 30px;">예약 취소 확인</h2>
	...
	<a href="Reserve_Check.jsp">이전</a>
	<a href="Reserve_Delete_Query.jsp">예약취소</a>
</section>
