...
<head>
<meta charset="UTF-8">
<title>Inha Hotel Reserve Update UI Page</title>
...
<h2 style="margin-top:50px; margin-bottom: 30px;">예약 변경</h2>
<hr style="margin: auto; width: 70%; height: 3px; background-color: black">
<div id="content">
	<section id="reservation_section">
		<form action="Reserve_Update_Check.jsp" id="reservation" method="post">
			<table id="table1">
				<tr>
					<td>체크인</td>
					<td>체크아웃</td>
					...
					<td>성인</td>
					<td>아동</td>
					<td rowspan="2"><input id="search" type="submit" value="검색" style="font-size: 16px"></td>
					<td rowspan="2"><a id="search" href="Reserve_Check.jsp" style="padding: 20px 45px;">이전</a></td>
				</tr>
				<tr>
			...
			<table id="table2">
				...
				<tr>
					<td id="price">1박 120,000~</td>
					<td>
						<input id="res" type="submit" name="_reserve" value="변경하기">
					</td>
				</tr>
			</table>
